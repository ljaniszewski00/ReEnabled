enum OtherText: String {
    case cameraModeMainRecognizer
    case cameraModeDocumentScanner
    case cameraModeColorDetector
    case cameraModeLightDetector
    
    case supportedLanguageEnglish
