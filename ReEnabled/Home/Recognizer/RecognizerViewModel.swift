...
class RecognizerViewModel: ObservableObject {
    ...
    private let MLModels: [MLModel?] = [try? ObjectDetector(configuration: MLModelConfiguration()).model]
    
    private var detectionOverlay: CALayer! = nil
    private var requests = [VNRequest]()
    
    private func buildRecognitionRequests() {
    ...
    private func recognizeObjectsFromCamera() {
    ...
    func setupAVCapture() {
        ...
        setupLayers()
        updateLayerGeometry()
        buildRecognitionRequests()
        recognizeObjectsFromCamera()
    ...
    private func updateLayerGeometry() {
        // MARK: PERFORM LAYERS UPDATE ON ORIGINAL ROOTLAYER OF CAMERAVIEW WHICH IS VIEW ITSELF
