...
class CaptureDepthSessionManager: ObservableObject {
    ...
    static var shared: CaptureDepthSessionManager = {
        return CaptureDepthSessionManager()
    }()
...
extension CaptureDepthSessionManager: NSCopying {
